                ...
                new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.getValue() != null){
                            ...
                            mDatabase.child("messages").orderByChild("sender").equalTo(username).addListenerForSingleValueEvent(new ValueEventListener() {
                                @Override
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    if(dataSnapshot.getValue()==null){
                                        ...
                                        mAdapter = new FirebaseRecyclerAdapter<Message, MessageViewHolder>(
                                                ...
                                                mDatabase.child("messages").orderByChild("sender").equalTo(username)) {

                                            @Override
                                            protected void populateViewHolder(MessageViewHolder viewHolder,Message model, int position) {

                                                viewHolder.userView.setText(model.getReceiver());
